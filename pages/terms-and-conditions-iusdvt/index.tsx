...
import { termsMeta, sections as termsSections } from "@/components/terms-and-conditions/TermsDataiUSDvt";
...
const TermsAndConditionsiUSDvt = () => {
    ...
    <>
      ...
      <main className="w-full h-full">
        <TermsAndConditions
          ...
          disclaimer="Important Disclaimer: IUSDVT is not FDIC insured; not insured by any federal government agency; is not a deposit or other obligation of, or guaranteed by, Vermont State Bank, or any of its affiliates."
...
export default TermsAndConditionsiUSDvt;