                ...
                <div className="py-12 sm:py-36">
                    <div className="flex flex-col sm:flex-row items-stretch justify-start gap-4 sm:gap-16 w-full mb-10 sm:mb-20">
                        <div className="sm:self-center">
                            <h6 className="text-sm sm:text-xl text-normal m-0">GET USDvt</h6>
                        </div>
                        <div className="self-start">
                            ...
                            <h6 className="text-base sm:text-xl text-disabled font-normal">
                              Join the growing community using USDvt for fast, safe, and 
                              borderless finance.
                            </h6>
                        </div>
                    ...
                    <div className="grid md:hidden grid-cols-3 h-[360px]">
                        ...
                        <div className="relative">
                            <Image src={'/images/trade-confirmed.webp'} alt="Trade Confirmed" loading="lazy" fill className="object-cover" />
                        </div>
                        <div className="relative">
...
export default DigitalMoneySection;
