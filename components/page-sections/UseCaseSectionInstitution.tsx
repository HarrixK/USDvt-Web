...
const UseCaseSectionInstitution: FC<UseCaseSectionProps> = (props) => {
    return (
            ...
            <Content>
                <div className="py-12 sm:py-36">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 sm:gap-8 mt-10 sm:mt-20 ">
                        <UseCaseCard
                            title={"Custodians and banks"}
                            imgUrl={"/images/custodians-banks.webp"}
                            subtext={
                                <>
                                    Issue or hold USDvt in compliance with regulatory frameworks
                                </>
                            }
                        />
                        <UseCaseCard
                        ...
                        <UseCaseCard
                            ...
                            subtext={
                                <>
                                    Manage high-volume settlements with audit-ready liquidity
                                </>
                            }
                        />
                    </div>
...
export default UseCaseSectionInstitution;
